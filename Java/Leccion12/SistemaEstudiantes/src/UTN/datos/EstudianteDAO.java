...
public class EstudianteDAO {
    ...
    public boolean modificarEstudiante(Estudiante estudiante){
        ...
        try {
            ps = con.prepareStatement(sql);
            ps.setString(1, estudiante.getNombre()); // Establece el nombre como String
            ps.setString(2, estudiante.getApellido()); // Establece el apellido como String
            ps.setString(3, estudiante.getTelefono()); // Establece el teléfono como String
            ps.setString(4, estudiante.getEmail()); // Establece el email como String
            ps.setInt(5, estudiante.getIdEstudiante()); // Establece el idEstudiante como int
            ps.execute();
            return true;
        } catch (Exception e) {
